        ...
        <div className=''>
          ...
          <div className='flex justify-between about'>
            <p className='column_text mr-5 font-bold mb-10'>
              Your ultimate companion for interactive and personalized learning. As a cutting-edge quiz webapp, Testifai goes beyond traditional methods, offering a dynamic platform that generates detailed tests and quizzes based on your chosen knowledge base. Whether you're studying from lecture notes, videos, or textbooks, Testifai adapts to your content, providing a tailored quiz experience that reinforces your understanding.
            </p>
